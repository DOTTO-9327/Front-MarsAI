        ...
        <section className="bg-white rounded-[3rem] p-8 md:p-12 border border-slate-200 shadow-sm relative overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="space-y-2">
              ...
              <Input type="text" placeholder={t('submission.placeholders.firstname')} />
            </div>
            <div className="space-y-2">
              <Label>{t('submission.sections.director.lastname')}</Label>
              <Input type="text" placeholder={t('submission.placeholders.lastname')} />
            </div>
            <div className="space-y-2">
              <Label>{t('submission.sections.director.email')}</Label>
              <Input type="email" placeholder={t('submission.placeholders.email')} />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input type="tel" placeholder={t('submission.placeholders.phone')} />
            </div>
          </div>
        ...
        <section className="bg-white rounded-[3rem] p-8 md:p-12 border border-slate-200 shadow-sm relative overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-2">
              ...
              <Input type="text" placeholder={t('submission.placeholders.orig_title')} />
            </div>
            <div className="space-y-2">
              <Label>{t('submission.sections.film.english_title')}</Label>
              <Input type="text" placeholder={t('submission.placeholders.intl_title')} />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <div className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-red-600 transition-colors"><Youtube className="w-4 h-4" /></div>
                <Input type="url" placeholder={t('submission.placeholders.youtube')} className="pl-12 pr-6" />
              </div>
            </div>
            ...
            <div className="md:col-span-2 space-y-2">
              ...
              <TextArea rows={4} placeholder={t('submission.placeholders.synopsis_orig')} />
            </div>
            ...
            <div className="md:col-span-2 space-y-2">
              ...
              <TextArea rows={4} placeholder={t('submission.placeholders.synopsis_en')} />
            </div>
          </div>
        </section>
        ...
        <section className="bg-mars-dark text-white rounded-[3rem] p-8 md:p-12 border border-white/10 shadow-2xl relative overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-8 relative z-10">
            ...
            <div className="space-y-2">
              ...
              <TextArea rows={4} placeholder={t('submission.placeholders.tools')} className="bg-white/5 border-white/10 text-white placeholder:text-slate-500 focus:bg-white/10 focus:border-primary" />
            </div>
            <div className="space-y-2">
              <Label className="text-slate-400">{t('submission.sections.tech.process')}</Label>
              <TextArea rows={4} placeholder={t('submission.placeholders.process')} className="bg-white/5 border-white/10 text-white placeholder:text-slate-500 focus:bg-white/10 focus:border-primary" />
            </div>
