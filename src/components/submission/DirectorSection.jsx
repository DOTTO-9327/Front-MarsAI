        ...
        <section className="bg-white rounded-[3rem] p-8 md:p-12 border border-slate-200 shadow-sm relative overflow-hidden">
            <div className="flex items-center gap-4 border-b border-slate-100 pb-6 mb-10">
                ...
                <div>
                    <h2 className="text-lg font-black uppercase tracking-widest leading-tight">
                        <span className="opacity-50 mr-2">01.</span>{t('sections.director.title')}
                    </h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-2">
                    ...
                    <Input type="text" placeholder={t('placeholders.firstname')} {...register("director.firstname", { required: "Le prénom est requis" })} className={errors.director?.firstname ? "border-red-500" : ""} />
                    {errors.director?.firstname && <ErrorMessage message={errors.director.firstname.message} />}
                </div>
                {/* NOM */}
                <div className="space-y-2">
                    <Label>{t('sections.director.lastname')}</Label>
                    <Input type="text" placeholder={t('placeholders.lastname')} {...register("director.lastname", { required: "Le nom est requis" })} className={errors.director?.lastname ? "border-red-500" : ""} />
                    {errors.director?.lastname && <ErrorMessage message={errors.director.lastname.message} />}
                </div>
                {/* EMAIL */}
                <div className="space-y-2">
                    <Label>{t('sections.director.email')}</Label>
                    <Input type="email" placeholder={t('placeholders.email')} {...register("director.email", { required: "L'email est requis", pattern: { value: /^[^\s@]+@[^\s@]+\.[^\s@]+$/, message: "Invalide" } })} className={errors.director?.email ? "border-red-500" : ""} />
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        <select {...register("director.gender")} className="w-full bg-mars-light border border-transparent px-6 py-4 rounded-2xl font-bold text-sm text-mars-dark appearance-none focus:outline-none focus:bg-white focus:border-primary transition-all uppercase cursor-pointer">
                            <option value="M">{t('sections.director.gender_options.m')}</option>
                            <option value="F">{t('sections.director.gender_options.f')}</option>
                            <option value="O">{t('sections.director.gender_options.o')}</option>
                        </select>
                ...
                <div className="space-y-2">
                    ...
                    <Input type="tel" placeholder={t('placeholders.phone')} {...register("director.phone", { required: "Le téléphone est requis" })} className={errors.director?.phone ? "border-red-500" : ""} />
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 pt-8 mt-8 border-t border-slate-100">
                <div className="relative group">
                    ...
                    <Input type="text" placeholder={t('placeholders.social_fb')} className="pl-12" {...register("director.social.facebook")} />
                </div>
                <div className="relative group">
                    ...
                    <Input type="text" placeholder={t('placeholders.social_insta')} className="pl-12" {...register("director.social.instagram")} />
                </div>
                <div className="relative group">
                    ...
                    <Input type="text" placeholder={t('placeholders.social_x')} className="pl-12" {...register("director.social.twitter")} />
                </div>
                <div className="relative group">
                    ...
                    <Input type="text" placeholder={t('placeholders.social_yt')} className="pl-12" {...register("director.social.youtube")} />
                </div>
            </div>
        </section>
    );
